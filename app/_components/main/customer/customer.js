...
import ImageGallery from "./customer-logos";
...
function Customer() {
  return (
    <section className='mb-sm px-6 md:px-0'>
      <div className='container mx-auto'>
        <h6 className='pb-lg text-center lg:pb-md lg:text-head-6 text-res-head-6 uppercase text-text-primaryBlue font-montserrat'>
          TRUSTED BY THE BEST
        </h6>
        <CustomerInfo />
