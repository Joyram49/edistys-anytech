  ...
  return (
    ...
    >
      <ul className='flex items-center flex-col space-y-8'>
        <li className='relative w-full whitespace-nowrap group lg:py-3 lg:px-6 lg:border-b border-white border-opacity-0 hover:border-opacity-100 transition-all duration-500 cursor-pointer !border-none'>
          ...
          >
            <span>Solutions</span>
            <svg
              className='ml-2 mt-1 fill-white transition-transform duration-300 peer-checked:rotate-180'
              width='9'
              height='6'
              viewBox='0 0 9 6'
              fill='none'
          ...
          {/* Dropdown Menu */}
          <span className='lg:absolute lg:top-full lg:bg-white lg:w-[240px] relative shadow-menu lg:text-text-primaryBlue rounded-sm hidden peer-checked:block'>
            <ul className='flex flex-col relative mt-6 lg:-mt-[1px]'>
              {/* Links */}
              {["anycaas", "anybaas", "anypaas"].map((item) => (
                <li
                  key={item}
                  className='lg:border-t border-border-lightBlue whitespace-nowrap first:border-none'
                >
                  <Link
                    href={`/en/solutions/${item}`}
                  ...
                  >
                    <span className='flex items-center text-body-p1'>
                      <svg
                        className='w-2 -rotate-90 fill-white  mr-2 lg:hidden'
                        width='9'
                        height='6'
                        viewBox='0 0 9 6'
                        fill='none'
        ...
        <div className='ml-6 my-auto'>
          ...
          <div className='lg:hidden block w-full'>
            <div className='w-full  border px-[14px] py-[8px] text-res-body-p1 text-white border-text-primaryBlue transition-all duration-75 rounded-[130px]'>
